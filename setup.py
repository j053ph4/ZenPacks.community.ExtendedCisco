...
NAME = "ZenPacks.community.ExtendedCisco"
VERSION = "1.0.0"
AUTHOR = "Joseph Anderson"
LICENSE = "Apache"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.community']
PACKAGES = ['ZenPacks', 'ZenPacks.community', 'ZenPacks.community.ExtendedCisco']
INSTALL_REQUIRES = ['ZenPacks.community.CiscoEnvMon', 'ZenPacks.community.ConstructionKit']
